...
&emsp;Fig. 1 shows the equivalent circuit for one mesh section and the topological representation of a rectangular prismatic mesh using a 3x3x3 area as an example. All contours of the rectangular mesh are used in the calculations. The interactive  [3D]([/tree/mainmesh.html](https://github.com/JNSresearcher/ECM_MS/img/mesh.htm)) tab in Fig. 1b) shows the numbering of branches and contours in detail (you can rotate, move, etc.).  
